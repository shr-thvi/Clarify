...
import { UserPlus, Mail, Lock, User as UserIcon, AlertCircle, Sparkles } from "lucide-react";

interface SignUpPageProps {
  onSignupSuccess: (token: string, user: { id: string; email: string; name: string }) => void;
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 font-sans">
      ...
      <div className="relative w-full max-w-md bg-slate-900/60 backdrop-blur-md border border-white/5 rounded-2xl p-8 space-y-6 shadow-2xl">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Join Clarify and start optimizing your doubts</p>
        </div>
